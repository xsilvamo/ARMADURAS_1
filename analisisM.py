...
vectorCoordenadasGlobales() Completado
matrizPi() Matriz de permutacion 
Armaduras() # accede a la clase armaduras
...
class AnalisisMatricial():
    ...
    def __init__(self, tabla_elem, tabla_nodos, tabla_fuerzas, tabla_desplazamientos):
        ...
        self.PI = self.matrizPi()

        self.armas = self.Armaduras()
    ...
    def Armaduras(self):
        ...
        for i in range(self.num_elem):
            ...
            element.append(armaduras.ARMADURAS(el, a, modE, xi, yi, xf, yf, [xil, yil, xfl, yfl]))
        return element
